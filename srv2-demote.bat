...
pg_basebackup -h 10.76.0.237 -D "C:\Program Files\PostgreSQL\10\data" -U postgres

copy "C:\Program Files\PostgreSQL\10\data\postgresql.conf.slave" "C:\Program Files\PostgreSQL\10\data\postgresql.conf"
copy "C:\Program Files\PostgreSQL\10\data\recovery.conf.srv2" "C:\Program Files\PostgreSQL\10\data\recovery.conf"
